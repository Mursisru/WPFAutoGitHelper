...
namespace WpfAutoGitHelper.Localization
{
    ...
    public sealed class LocalizedUi : INotifyPropertyChanged
    {
        ...
        public string TipReleaseAssetsContextMenu => Loc.Get("Tip_ReleaseAssetsContextMenu");
        public string TipChangedFilesContextMenu => Loc.Get("Tip_ChangedFilesContextMenu");
        ...
        public string SettingsDefaultUiModeHint => Loc.Get("Settings_DefaultUiModeHint");
        public string CtxBrowseFolder => Loc.Get("CtxBrowseFolder");
        public string CtxSaveRepo => Loc.Get("CtxSaveRepo");
        public string CtxRefreshStatus => Loc.Get("CtxRefreshStatus");
        public string CtxOpenFolder => Loc.Get("CtxOpenFolder");
        public string CtxOpenGitHub => Loc.Get("CtxOpenGitHub");
        public string CtxRefreshFiles => Loc.Get("CtxRefreshFiles");
        public string CtxCut => Loc.Get("CtxCut");
        public string CtxCopy => Loc.Get("CtxCopy");
        public string CtxPaste => Loc.Get("CtxPaste");
        public string CtxSelectAll => Loc.Get("CtxSelectAll");
